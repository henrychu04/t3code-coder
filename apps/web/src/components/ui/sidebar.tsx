  ...
  return (
    <SidebarInstanceContext value={instanceContextValue}>
      ...
      >
        ...
        <div
          className={cn(
            "relative w-(--sidebar-width) bg-transparent [[data-panel-animations=true]_&]:transition-[width] [[data-panel-animations=true]_&]:[transition-duration:var(--panel-animation-duration)] ease-out",
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) [[data-panel-animations=true]_&]:transition-[left,right,width] [[data-panel-animations=true]_&]:[transition-duration:var(--panel-animation-duration)] ease-out md:flex",
            side === "left"
