...
describe("sortSettledThreadsForSidebar", () => {
  ...
  it("falls back to last activity for legacy settled threads without a settledAt stamp", () => {
    const sorted = sortSettledThreadsForSidebar([
  ...
  it("counts a turn completion as fallback activity for legacy settled threads", () => {
