...
function getPublishProviderReadiness(input: {
  ...
  if (!discovered) {
    return {
      ready: false,
      hint: "GitLab status is unavailable in the Coder workspace.",
    };
  }
  ...
  if (discovered.auth.status === "unauthenticated") {
    return {
      ...
      hint:
        ...
        `${discovered.label} is not authenticated. Run glab auth login in the Coder workspace.`,
    };
  }
                        ...
                        >
                          ...
                          <Tooltip>
                            ...
                            <TooltipPopup side="top" align="end" className="max-w-72">
                              {readiness.hint ?? "Run glab auth login in the Coder workspace."}
                            </TooltipPopup>
                          </Tooltip>
                        </div>
                      );
