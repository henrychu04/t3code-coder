...
export function pullRequestMatchesProject(
  ...
  return (
    ...
    pullRequest.repositoryKey === project.repositoryIdentity.canonicalKey
  );
}
          ...
          const plans = yield* Effect.forEach(group, (thread) =>
            Effect.gen(function* () {
              ...
              if (
                ...
                const previous = yield* pullRequests.detail(thread.branchPullRequest);
              ...
              if (
                ...
                const linked = yield* pullRequests.detail(thread.linkedPullRequest);
